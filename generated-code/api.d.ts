...
export interface BankTransferEventListRequest {
    ...
    /**
     * The maximum number of bank transfer events to return. Count should be in the range 1 to 25.  If a number out of range is provided, then you will receive an `INVALID_FIELD` error. Default value if unspecified is 25.   If the number of events matching the above parameters is greater than `count`, the most recent events will be returned.
     * @type {number}
     * @memberof BankTransferEventListRequest
     */
    count?: number;
    /**
     * The offset into the list of bank transfer events. When `count`=25 and `offset`=0, the first 25 events will be returned. When `count`=25 and `offset`=25, the next 25 bank transfer events will be returned. Default value if unspecified is 0.
     * @type {number}
     * @memberof BankTransferEventListRequest
     */
    offset?: number;
...
export interface BankTransferEventSyncRequest {
    ...
    after_id: number;
    /**
     * The maximum number of bank transfer events to return. Count should be in the range 1 to 25. If a number out of range is provided, then you will receive an `INVALID_FIELD` error.  Default value if unspecified is 25.
     * @type {number}
     * @memberof BankTransferEventSyncRequest
     */
    count?: number;
...
export interface BankTransferListRequest {
    ...
    end_date?: string;
    /**
     * The maximum number of bank transfers to return, with 0 < `count` <= 25.  If a number out of range is provided, then you will receive an `INVALID_FIELD` error. Default value if unspecified is 25.
     * @type {number}
     * @memberof BankTransferListRequest
     */
    count?: number;
    /**
     * The number of bank transfers to skip before returning results, with `offset` >= 0. If not specified, the default value is 0.
     * @type {number}
     * @memberof BankTransferListRequest
     */
    offset?: number;
...
/**
 * One of `\"pending\"`, `\"posted\"`, `\"cancelled\"`, `\"failed\"`, or `\"reversed\"`
 * @export
 * @enum {string}
 */
...
export interface ProcessorTokenCreateRequest {
    ...
    account_id: string;
    /**
     * The processor you are integrating with. Valid values are `\"achq\"`, `\"drivewealth\"`, `\"dwolla\"`, `\"galileo\"`, \"`interactive_brokers`\", `\"modern_treasury\"`, `\"ocrolus\"`, `\"papayapay\"`, `\"prime_trust\"`, `\"velox\"`, `\"vesta\"`, `\"vopay\"`
     * @type {string}
     * @memberof ProcessorTokenCreateRequest
     */
    processor: string;
